...
CREATE TABLE `admin` (
  `ad_lastname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `ad_firstname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `admin` (`ad_lastname`, `ad_firstname`, `ad_password`, `ad_email`, `base_id`) VALUES
('Emmanuel', 'Peter', '827ccb0eea8a706c4c34a16891f84e7b', 'peter@gmail.com', '1');

-- --------------------------------------------------------

--
-- Table structure for table `base_stat`
--
...
CREATE TABLE `base_stat` (
  ...
  `channels_num` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `connect_num` varchar(11) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `base_stat`
--

INSERT INTO `base_stat` (`base_id`, `nsp`, `city`, `state`, `channels_num`, `connect_num`) VALUES
('BA02YEN', 'MTN', 'Yenagoa', 'Bayelsa', '60', '46'),
('BS01NEM', 'MTN', 'Nembe', 'Bayelsa', '40', '34'),
('BS01SAH', 'MTN', 'Sagbama', 'Bayelsa', '30', '15'),
('BS01YEN', 'MTN', 'Yenagoa', 'Bayelsa', '100', '24'),
('BS02SAH', 'MTN', 'Saghama', 'Bayelsa', '25', '24');
...
INSERT INTO `base_station` (`base_id`, `nsp`, `city`, `state`, `channels_num`, `connect_num`) VALUES
...
CREATE TABLE `calls` (
  ...
  `call_number` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `receiver_no` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `calls` (`call_id`, `call_start_time`, `call_duration`, `date_of_call`, `call_number`, `receiver_no`, `email`, `base_id`) VALUES
...
(12, '04:58:31pm', '41', '05/12/2019', '07062223456', '08051113455', 'oge@gmail.com', '2'),
(13, '10:35:14pm', '25', '11/12/2019', '08104380838', '07063032259', 'oge@gmail.com', '3'),
(14, '04:58:31pm', '41', '05/12/2019', '07062223456', '08051113455', 'oge@gmail.com', '2'),
...
CREATE TABLE `network_line` (
  ...
  `caller_number` varchar(11) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `network_line` (`id`, `sub_email`, `nsp`, `caller_number`) VALUES
...
CREATE TABLE `subscriber` (
  `sub_lastname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `subscriber` (`sub_lastname`, `sub_firstname`, `sub_email`, `dob`, `sex`, `sub_password`) VALUES
...
--
-- Indexes for table `base_stat`
--
ALTER TABLE `base_stat`
