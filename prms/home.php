...
<?php
    ...
    if(isset($_POST['register'])){
        ...
        $patient_id = $first[random_int(0,27)].$random.$second[random_int(0,27)];
        ...
        $result = mysqli_query($conn, $sqlPatient);
         if($result){
             ...
             echo "<script>alert('patient account created successfully')</script>";
         }else{
  ...
  <div class="container-fluid" id = "imgc">
      <div class="container">
          <div class="row d-flex justify-content-between" >
            ...
            <form action=""> <button type = "submit" class = "btn btn-primary-outline"><a href="logout.php" style = "text-decoration:none;color:black;font-weight:bold">Logout</a></button></form>
          </div>
          ...
          <div class="row">
              ...
              <div class="col-4 mt-4 text-center mybutton">
                    <div class = "card text-center p-2" style = "cursor:pointer">
                        <h6 class = "mybutton" style = "cursor:pointer"><a href = "#" data-toggle="modal" data-target="#register" style = "text-decoration:none; color:black;">Add New Patient</a></h6>
                    </div>
              </div>
              <div class="col-4 mt-4 text-center mybutton" style = "cursor:pointer">
                    <div class = "card text-center p-2" style = "cursor:pointer">
                        <h6 class = "mybutton"><a href = "view-patients.php" style = "text-decoration:none; color:black;">View Patient Record</a></h6>
                    </div>
              </div>

              <div class="col-4 mt-4 text-center">
                    <div class = "card text-center p-2 mybutton" style = "cursor:pointer">
                       <h6 class = "mybutton"><a href = "view-patient-generate-card.php" style = "text-decoration:none; color:black;">Generate Patient Card</a></h6>
                    </div>
              </div>
          </div>
      </div>
