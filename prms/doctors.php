  ...
  <div class="container-fluid" id = "imgc">
      <div class="container">
          <div class="row d-flex justify-content-between" >
            ...
            <form action=""> <button type = "submit" class = "btn btn-primary-outline"><span class = "font-weight-bold">Logout</span></button></form>
          </div>
          ...
          <div class="row">
              ...
              <div class="col-4 mt-4 text-center mybutton">
                    <div class = "card text-center p-2" style = "cursor:pointer">
                        <a href = "view-dnurse-diagnosis.php" style = "text-decoration:none; color:black;cursor:pointer">View Examined Patient Record</a></h6>
                    </div>
              </div>
              <div class="col-4 mt-4 text-center mybutton" style = "cursor:pointer">
                    <div class = "card text-center p-2" style = "cursor:pointer">
                        <a href = "view-doctor-diagnosis.php" style = "text-decoration:none; color:black;cursor:pointer">View Diagnosed Patient Records</a></h6>
                    </div>
              </div>
